...
public class FacturaVentas {
    ...
    public FacturaVentas(List<Ventas> ventas) {
        this.ventas = ventas;
    }
    ...
    public void writeHeader(PdfPTable pdfTable){
        ...
        cell.setPhrase(new Phrase("Valor unitario"));
        pdfTable.addCell(cell);
    ...
    public void writeTableData(PdfPTable pTable){
        for (Ventas venta : ventas) {
            ...
            pTable.addCell(venta.getCantidad()+"");
            pTable.addCell(venta.getPriceProduct()+"");
            pTable.addCell(venta.getProductName());
            pTable.addCell(venta.getPrecioTotal()+"");
        }
    }
    ...
    public void export(HttpServletResponse response) throws DocumentException{
       ...
       /*     com.lowagie.text.Image header = com.lowagie.text.Image.getInstance("Electro.jpg");
            ...
            document.add(header);
        */    
            Paragraph paragraph = new Paragraph("Factura de Venta");
